...
<body onload="settingUserDetailLoad();">
							<div class="card" style="height: 700px;">
								...
								<div class="content">
									id:<input type="text" disabled="disabled" id="user_detail_id" value="${userId }"><br>
									...
									<div class="col-md-3">
										<select size="10" style="width:150px" id="Role_list_settingUserDetail">
										</select>
									</div>
									<div class="col-md-3">
										<button type="button" onclick="Role_list_add();">
											<span>ADD</span>
										</button>
										<button type="button" onclick="Role_list_delete();">
											<span>DELETE</span>
										</button>
									</div>
									<div class="col-md-6">
									...
									<div class="col-md-3">
										<select size="10" style="width:150px" id="Role_all_settingUserDetail">
										</select>
									</div>
								</div>
								<div>
									<button onclick="Setting_userDetail_submit();">Submit</button>
