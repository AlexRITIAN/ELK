...
<body onload="addRoleDetailLoad();">
							<div class="card" style="height: 700px;">
								...
								<div class="content">
									...
									<div class="col-md-3">
										<select size="10" style="width:150px" id="permission_list_addroleDetail">
										</select>
									</div>
									<div class="col-md-3">
										<button type="button" onclick="addRole_Permission_list_add();">
											<span>ADD</span>
										</button>
										<button type="button" onclick="addRole_Permission_list_delete();">
											<span>DELETE</span>
										</button>
									</div>
									<div class="col-md-6">
									...
									<div class="col-md-3">
										<select size="10" style="width:150px" id="permission_all_addroleDetail">
										</select>
									</div>
								</div>
								<div>
									<button onclick="add_roleDetail_submit();">Submit</button>
