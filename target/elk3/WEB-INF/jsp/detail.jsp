                ...
                <div class="row">
                    <div class="col-md-12">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="col-md-3">
									<button id="upPage" onclick="detail_upPage_btn_click();" type="button"
								...
								<div class="col-md-3">
									<button id="downPage" onclick="detail_downPage_btn_click();"
